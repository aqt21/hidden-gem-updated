			...
			<div>
				<div id='mod'>
					<div className='container'>
						<a className="waves-effect waves-light btn-large mod-button" onClick={() => this.handlePending()}>Pending Review</a>
						<a className="waves-effect waves-light btn-large mod-button" onClick={() => this.handleApproved()}>Approved</a>
						<a className="waves-effect waves-light btn-large mod-button" onClick={() => this.handleDiscarded()}>Discarded</a>
						{(this.state.showInfo ?
